...
const BentoCard = ({
  ...
  >
    ...
    <div className="pointer-events-none z-10 flex transform-gpu flex-col gap-1 p-6 transition-all duration-300 group-hover:-translate-y-10">
      ...
      {description && <p className="text-xl font-semibold text-neutral-700 dark:text-neutral-300">{description}</p>}
    </div>
    ...
    >
      {href === "N/A" ? <></> : <Button variant="ghost" asChild size="sm" className="pointer-events-auto">
        <a href={href}>
          {cta}
