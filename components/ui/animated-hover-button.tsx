...
const HoverButton = React.forwardRef<HTMLButtonElement, HoverButtonProps>(
  (
    ...
    const sizeConfig = {
      small: { padding: "px-3 py-1.5", text: "text-sm" },
      medium: { padding: "px-6 py-2.5", text: "text-base" },
      large: { padding: "px-10 py-4", text: "text-lg" },
    };
    ...
    return (
      <button
        ref={buttonRef}
        className={cn(
          `relative isolate ${padding} rounded-full text-white font-semibold ${text}`,
          "backdrop-blur-xl bg-[rgba(43,55,80,0.2)] shadow-lg",
